...
/**
 * @version: $Id: org.mng.components.js 6622 2014-09-19 08:28:27Z agodovanets $
 */
...
orgModule.orgManager.properties = {
    ...
    initialize: function() {
        ...
        orgModule.properties.validate = function() {
            ...
            return ValidationModule.validateLegacy(orgProperties._validators) && invokeOrgAction("aliasExist", {
                org: org,
                onExist: function(uniqueAlias) {
