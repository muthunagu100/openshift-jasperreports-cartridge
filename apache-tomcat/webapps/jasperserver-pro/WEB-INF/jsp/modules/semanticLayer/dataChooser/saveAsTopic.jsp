...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
    ...
    <t:putAttribute name="moduleName" value="dataChooser/pages/saveAsTopicPage"/>
                        ...
                        <t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
                                ...
                                <t:putAttribute name="bodyContent">
                                    ...
                                    <c:if test="${stagingEnabled}">
	                                    <label class="control checkBox" for="dataStrategy_staged" title="<spring:message code='page.saveAsTopic.enableStaging.title' javaScriptEscape="true"/>">
	                                    ...
	                                    <label class="control input text" for="dataStrategy_dataLifetimeMinutes" title="<spring:message code='page.saveAsTopic.dataLifetime.title' javaScriptEscape="true"/>">
	                                        <span class="wrap"><spring:message code="page.saveAsTopic.dataLifetime"/>:</span>
	                                        <input class="" id="dataStrategy_dataLifetimeMinutes" type="text" value="${dataStrategy_dataLifetimeMinutes}"/>
	                                        <span class="message warning"></span>
	                                    </label>
									</c:if>
