...
<script type="text/javascript">
    ...
    var saveFolder = "<spring:message code="${requestScope.aruFolder}" javaScriptEscape="true"/>";
    var saveUri = "<spring:message code="${requestScope.aruUri}" javaScriptEscape="true"/>";
    var saveLabel = "<spring:message code="${requestScope.aruLabel}" javaScriptEscape="true"/>";
    var saveDesc = "<spring:message code="${requestScope.aruDesc}" javaScriptEscape="true"/>";
    // default save name (if new)
    var defaultSaveName = "<spring:message code="${requestScope.defaultAruName}" javaScriptEscape="true"/>";
    ...
    <%
        ...
        LicenseCheckStatus licenseStatus = lm.checkLicense();

        if (licenseStatus.isLicenseAccepted() && lm.isProductEditionFreeOrLimited() ) { %>
        __jrsConfigs__.isFreeOrLimitedEdition = true;
    <%  } %>
    ...
    var embeddedName = "<spring:message code="${embeddedName}" javaScriptEscape="true"/>";
    var embeddedSaveAsUri = "<spring:message code="${embeddedSaveAsUri}" javaScriptEscape="true"/>";
